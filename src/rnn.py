...
class RNN(object):
    def __init__(self,
        ...
        l_recurrent = lasagne.layers.RecurrentLayer(l_in, hidden_size, nonlinearity=None)
        ...
        e_context = l_recurrent.get_output(c_input, deterministic=True)[:,-1,:].reshape((r.shape[0], -1))
